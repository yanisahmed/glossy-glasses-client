        ...
        <div className="single-product w-72 mx-auto border-2 relative">
            ...
            <div className="bg-gray-200 p-4 h-44">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <span>
                        <Link to={`/products/${product._id}`}><button className="mr-2 py-2 px-4 bg-gray-700 text-white rounded"><FontAwesomeIcon icon={faShoppingCart} className="mr-2 text-yellow-500" />Buy</button></Link>
                    </span>
                </div>
            </div>
        </div>
